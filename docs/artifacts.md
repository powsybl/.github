...
PowSyBl can be used as a plain Java library to develop your own application. Depending on the features you need, you would choose artifacts from the list below. This page aims at listing them, summarizing their purpose and helping you figure out what you need in your 'pom.xml' file.

The PowSyBl artifacts are available in [Maven Central](https://repo.maven.apache.org/maven2/com/powsybl/) under the groundId `com.powsybl`.
...
This module provides a common API to access to the CIM-CGMES from a triple store. Several implementations are available but we suggest to use thett Eclipse RDF4J one that offers the best performance.

**powsybl-triple-store-impl-rdf4j**  
This module provides SPARQL queries to access a triple store based on [Eclipse RDF4J](https://rdf4j.org/).

**powsybl-triple-store-impl-jena**  
This module provides SPARQL queries to access a triple store based on [Jena](https://jena.apache.org).

**powsybl-cgmes-conformity**  
This module implements the ENTSO-E conformity tests.

**powsybl-cim-anonymiser**  
This module provides a tool to anonymize identifiers of a CIM-CGMES file.

#### IEEE-CDF

The following artifacts provide the support for the [IEEE-CDF]() format.
...
The following artifacts provide the support for the [PSSE/E]() format.
...
The following artifacts provide the support for the [MatPower]() format.
...
This module provides additional features around the network. This module was removed in v4.0.0 and its content was moved to the `powsybl-iidm-api` module.
